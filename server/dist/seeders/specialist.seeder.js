...
exports.SpecialistSeeder = void 0;
...
class SpecialistSeeder extends base_seeder_1.BaseSeeder {
    async seed() {
        ...
        for (const specData of specialists) {
            ...
            const feeTier = allFees.find(fee => specData.base_price >= fee.min_value && specData.base_price <= fee.max_value) || allFees[0];
...
exports.SpecialistSeeder = SpecialistSeeder;
