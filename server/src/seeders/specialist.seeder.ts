...
import { ESpecialistVerificationStatus, Specialist } from "../entities/Specialist";
    ...
    const specialists = [
      {
        ...
        base_price: 1700.00,
        duration_days: 15,
        verification_status: ESpecialistVerificationStatus.APPROVED,
        is_verified: true,
        average_rating: 4.7,
      ...
      },
      {
        ...
        base_price: 1100.00,
        duration_days: 11,
        verification_status: ESpecialistVerificationStatus.PENDING,
        is_verified: false,
        average_rating: 4.4,
